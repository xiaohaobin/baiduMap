...
(function() {
	...
	d.prototype._initContainer = function() {
		...
		m.style.cssText = j;
		g.appendChild(p);
		g.appendChild(document.createTextNode("鐪�"));
		g.appendChild(r);
		g.appendChild(document.createTextNode("甯�"));
		g.appendChild(i);
		g.appendChild(document.createTextNode("鍖�"));
		g.appendChild(m);
		g.appendChild(document.createTextNode("鍟嗗湀"));
